        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className={`lg:w-72 shrink-0 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6 sticky top-24">
              ...
              {/* Room Type */}
              <div className="mb-6">
                <label className="text-xs font-semibold text-text-secondary uppercase tracking-wider mb-3 block">Room Type</label>
                      ...
                      <div className="flex flex-col flex-grow p-4">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="text-right">
                            <span className="text-lg font-bold text-accent">₹{parseFloat(room.price_per_night).toLocaleString()}</span>
